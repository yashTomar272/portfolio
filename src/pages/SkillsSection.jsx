...
<h2 className="different w-100 text-center mt-4"><FadeIn>DAYS I CODE</FadeIn></h2>
 <FadeIn><div className="d-flex  align-items-center justify-content-center">
   <div style={{maxWidth:"856px", width:"90vw"}} className="d-flex  align-items-center mt-3 flex-column justify-content-center">
      {/* Month Labels */}
      <div style={{maxWidth:"856px"}} className=" month-labels p-0 w-100 d-flex justify-content-center align-items-center">
        <div  className="w-100 d-flex justify-content-between align-items-center">
          {months.map((month, i) => (
            <div key={i} className="month-name small">
              {month}
            </div>
          ))}
        </div>
